...
CKEDITOR.plugins.add( 'myforms', {
	requires: 'dialog,fakeobjects',
	lang: 'en,lt', // %REMOVE_LINE_CORE%
	icons: 'button,checkbox,form,hiddenfield,imagebutton,radio,select,select-rtl,textarea,textarea-rtl,textfield,captcha', // %REMOVE_LINE_CORE%
	onLoad: function() {
	...
	init: function( editor ) {
		...
		var addButtonCommand = function( buttonName, commandName, dialogFile ) {
				...
				editor.ui.addButton && editor.ui.addButton( buttonName, {
					label: lang.myforms.btn[ buttonName.charAt( 0 ).toLowerCase() + buttonName.slice( 1 ) ],
					command: commandName
				});
		...
		addButtonCommand( 'Button', 'button', dialogPath + 'button.js' );
                addButtonCommand( 'Captcha', 'captcha', dialogPath + 'captcha.js' );

//                CKEDITOR.dialog.add( 'form', dialogPath + 'captcha.js' );
//                editor.addCommand("form", new CKEDITOR.dialogCommand("captcha"));
//                editor.ui.addButton("form", {label: editor.lang.myforms.captcha.title, command: "captcha", toolbar: ''});
...
//				captcha: {
//					label: lang.myforms.captcha.title,
//					command: 'captcha',
//					group: 'captcha'
//				},
