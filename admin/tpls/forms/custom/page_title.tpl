<div id="id_{form_settings.id}_{elm.name}" class="formElementsField {elm.style}">
	...
	<div class="e">
		...
		<input type="checkbox" {block elm.editorship no}checked{-block elm.editorship no} value="1" name="generate_{elm.column_name}" id="gen_{elm.column_name}_auto_id" style="vertical-align:middle;" /> <label for="gen_{elm.column_name}_auto_id">Auto &lt;TITLE&gt;</label>
	</div>
</div>
...
{block _form_data.generate_page_title.value}
