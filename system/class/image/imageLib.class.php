...
## --------------------------------------------------------
  ...
  # Date:     27-02-08    
    ...
    //$fileName = "http://www.omega3nauda.lt/files/Main/images/testas%20pasaulyje%20opapa.png";    
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/ 
  ...
  public function addImage($watermarkImage, $x, $y, $opacity = 0)
    # Author:     Vytautas Baltmiskis
    # Date:       2012-11-03
    # Purpose:    Add image
  {
...
## -------------------------------------------------------- 
    ...
    if (!file_exists($file) && !$this->checkStringStartsWith('http://', $file) && !$this->checkStringStartsWith('https://', $file)) { if ($this->debug) { die('Image not found.'); }else{ die(); }};
