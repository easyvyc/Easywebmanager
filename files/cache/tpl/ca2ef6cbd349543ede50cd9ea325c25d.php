...
<div class="paging">
	<a href="javascript: void(e_multiDialog.open_url('<?php echo TPL::getVar("grid_data.grid_name"); ?>_0', '?module=<?php echo TPL::getVar("grid_data.grid_name"); ?>&method=edit&id=0&ajax=1'));"><img src="admin/images/actions/new.gif" alt="" class="vam" />&nbsp;<?php echo TPL::getVar("phrases.main.catalog.new_element"); ?></a>
	<a href="javascript: void();"><img src="admin/images/actions/export.gif" alt="" class="vam" />&nbsp;<?php echo TPL::getVar("phrases.main.catalog.export"); ?></a>
	<a href="javascript: void(e_multiDialog.open_url('<?php echo TPL::getVar("grid_data.grid_name"); ?>_0', '?module=<?php echo TPL::getVar("grid_data.grid_name"); ?>&method=settings&ajax=1'));"><img src="admin/images/actions/settings.gif" alt="" class="vam" />&nbsp;<?php echo TPL::getVar("phrases.main.catalog.settings"); ?></a>
</div>
...
gridObject___<?php echo TPL::getVar("grid_data.grid_name"); ?> = new gridClass('<?php echo TPL::getVar("grid_data.grid_name"); ?>');
	...
	<tr class="item" id="item_row_<?php echo $v_items['id']; ?>">
		...
		<td class="column w10 center" rel="editbutton" id="item___editbutton___<?php echo $v_items['id']; ?>">
			...
			<a href="javascript: void(e_multiDialog.open_url('<?php echo TPL::getVar("grid_data.grid_name"); ?>_<?php echo $v_items['id']; ?>', '?module=<?php echo TPL::getVar("grid_data.grid_name"); ?>&method=edit&ajax=1&id=<?php echo $v_items['id']; ?>'));"><img src="admin/images/actions/<?php if($v_items['lng_saved']){ ?>edit<?php }else { ?>not_saved<?php } ?>.gif" border="0"></a>
			<?php } ?>
		</td>
		<?php } ?>
		...
		<td class="column w10 center" rel="dublicatebutton" id="item___dublicatebutton___<?php echo $v_items['id']; ?>">
			<?php if($v_items['editorship']){ ?>
			<a href="javascript: void(e_multiDialog.open_url('<?php echo TPL::getVar("grid_data.grid_name"); ?>_<?php echo $v_items['id']; ?>', '?module=<?php echo TPL::getVar("grid_data.grid_name"); ?>&parent_id=<?php echo TPL::getVar("parent_id"); ?>&ajax=1&new=1&duplicate=<?php echo $v_items['id']; ?><?php if(TPL::getVar("get.filters")){ ?>&filters=<?php echo TPL::getVar("get.filters"); ?><?php } ?>'));"><img src="admin/images/duplicate.gif" border="0"></a>
			<?php } ?>
		</td>
		<?php } ?>
		...
		<td class="column w10 center" rel="deletebutton" id="item___deletebutton___<?php echo $v_items['id']; ?>">
			<?php if($v_items['editorship']){ ?>
			<a href="javascript: e_multiDialog.open_url('<?php echo TPL::getVar("grid_data.grid_name"); ?>_<?php echo $v_items['id']; ?>', '?module=<?php echo TPL::getVar("grid_data.grid_name"); ?>&method=delete&ajax=1&id=<?php echo $v_items['id']; ?>');"><img src="admin/images/actions/delete.gif" border="0" alt="" /></a>
			<?php } ?>
		</td>
		<?php } ?>
