<div id="id_<?php echo TPL::getVar("elm.name"); ?>" class="formElementsField <?php echo TPL::getVar("elm.style"); ?>">
	...
	<div class="e">
		...
		<input type='password' name='<?php echo TPL::getVar("elm.name"); ?>_1' value="" class='<?php echo TPL::getVar("style"); ?>_<?php echo TPL::getVar("elm.elm_type"); ?>' autocomplete="off" /><br />
	...
	<div class="e">
		...
		<input type='password' name='<?php echo TPL::getVar("elm.name"); ?>_2' value="" class='<?php echo TPL::getVar("style"); ?>_<?php echo TPL::getVar("elm.elm_type"); ?>' autocomplete="off" />
