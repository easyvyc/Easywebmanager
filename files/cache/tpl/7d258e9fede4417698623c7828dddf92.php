<div id="id_<?php echo TPL::getVar("form_settings.id"); ?>_<?php echo TPL::getVar("elm.name"); ?>" class="formElementsField <?php echo TPL::getVar("elm.style"); ?>">
	...
	<div class="e">
		...
		<input type="checkbox" <?php if(!TPL::getVar("elm.editorship")){ ?>checked<?php } ?> value="1" name="generate_<?php echo TPL::getVar("elm.column_name"); ?>" id="gen_<?php echo TPL::getVar("elm.column_name"); ?>_auto_id" style="vertical-align:middle;" /> <label for="gen_<?php echo TPL::getVar("elm.column_name"); ?>_auto_id">Auto &lt;H1&gt;</label>
	</div>
</div>
...
<?php if(TPL::getVar("_form_data.generate_header_title.value")){ ?>
