<div id="id_<?php echo TPL::getVar("elm.name"); ?>" class="formElementsField <?php echo TPL::getVar("elm.style"); ?>" <?php if(TPL::getVar("elm.extra_block_style")){ ?>style="<?php echo TPL::getVar("elm.extra_block_style"); ?>"<?php } ?>>
	...
	<div class="e">
		<input type='text' name='<?php echo TPL::getVar("elm.name"); ?>' id="ELMID_<?php echo TPL::getVar("elm.column_name"); ?>" value='<?php echo TPL::getVar("elm.value"); ?>' class='FRM <?php echo TPL::getVar("style"); ?>_<?php echo TPL::getVar("elm.elm_type"); ?>' <?php if(!TPL::getVar("elm.editable")){ ?>readonly<?php } ?> <?php echo TPL::getVar("elm.extra_params"); ?> >
	</div>
</div>
