...
<?php $actions_iterator=1; foreach(TPL::getLoop("actions") as $actions_key => $actions_val){ $actions_val['_FIRST']=0; if($actions_iterator==1) $actions_val['_FIRST']=1; if($actions_iterator%2==1) $actions_val['_EVEN']=0; else $actions_val['_EVEN']=1; $actions_val['_INDEX']=$actions_iterator++; ?>
