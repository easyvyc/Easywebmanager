...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "fb.php?module=fb_app&method=upload&params[id]=<?php echo TPL::getVar("id"); ?>&ajax=1",
		file_size_limit : "10240",
		post_params: {"_SESSION_ID_" : "<?php echo TPL::getVar("session_id"); ?>" },
		...
		.bind('uploadComplete', function(event, file){
			...
			$('#swfupload_img').html("<img src='"+$FB_APP.uploadurl+"<?php echo TPL::getVar("id"); ?>/"+file.name+"' height='35' >");
...
if(typeof($FB_APP.info.data.<?php echo TPL::getVar("id"); ?>)!='undefined'){
	if(typeof($FB_APP.info.data.<?php echo TPL::getVar("id"); ?>.url)!='undefined'){
		$('#swfupload_img').html("<img src='"+$FB_APP.uploadurl+"<?php echo TPL::getVar("id"); ?>/"+$FB_APP.info.data.<?php echo TPL::getVar("id"); ?>.url+"' height='35' >");
		$('#swfupload_file').val($FB_APP.info.data.<?php echo TPL::getVar("id"); ?>.url);
	}
	...
	/*
	$FB_APP.info.<?php echo TPL::getVar("id"); ?> = $FB_APP.info.<?php echo TPL::getVar("id"); ?>
	*/
}

function setBanner(){
	$FB_APP.change("<?php echo TPL::getVar("id"); ?>", "url", $('#swfupload_file').val());
