...
<script type="text/javascript" src="<?php echo TPL::getVar("config.admin_dir"); ?>js/jquery.js"></script>
...
function remind(){
	...
	$.ajax({
		  type: "POST",
		  async: true,
		  url: "<?php echo TPL::getVar("config.admin_url"); ?>?action=login&module=admins&method=remind&ajax=1",
		  cache: false,
		  data: $($obj).serialize(),
		  dataType: "json",
		  beforeSend: function(){
			  ...
			  $('#remind_form .message').html("<img src='<?php echo TPL::getVar("config.admin_dir"); ?>images/loading_watch.gif' alt='' > <?php echo TPL::getVar("phrases.login.loading"); ?>");
		  },
...
<body>
	...
	<div id="container">
		...
		<div id="logo">
	  		<a href="http://www.easywebmanager.com" target="_blank"><img src="<?php echo TPL::getVar("config.admin_dir"); ?>images/logo.png" border="0" alt="" ></a>
		</div>

	
		<div class="login">
		  	<a href="javascript: void(show('login'));" id="login_link"><img src="<?php echo TPL::getVar("config.admin_dir"); ?>images/lock.gif" border="0" alt="" > <?php echo TPL::getVar("phrases.login.login"); ?></a>
		  	<a href="javascript: void(show('remind'));" id="remind_link"><img src="<?php echo TPL::getVar("config.admin_dir"); ?>images/lock.gif" border="0" alt="" > <?php echo TPL::getVar("phrases.login.password_remind"); ?></a>
		</div>
