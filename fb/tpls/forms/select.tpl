<div id="id_{elm.name}" class="formElementsField {elm.style}">
	...
	<div class="e">
		<select name='{elm.name}' id="ELMID_{elm.column_name}" class='{style}_{elm.elm_type}' {block elm.list_values.multiple}multiple size="6"{-block elm.list_values.multiple} {elm.extra_params}>
		<option value="">-------------</option>
