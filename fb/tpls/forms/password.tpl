<div id="id_{elm.name}" class="formElementsField {elm.style}">
	...
	<div class="e">
		...
		<input type='password' name='{elm.name}_1' value="" class='{style}_{elm.elm_type}' autocomplete="off" /><br />
	...
	<div class="e">
		...
		<input type='password' name='{elm.name}_2' value="" class='{style}_{elm.elm_type}' autocomplete="off" />
