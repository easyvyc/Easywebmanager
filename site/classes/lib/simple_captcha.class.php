...
class lib_simple_captcha extends lib {
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            $fontsize = rand($fontcfg['minSize'], $fontcfg['maxSize'])*$this->scale*$fontSizefactor * $this->size;
    ...
    protected function ReduceImage() {
        ...
        if($this->transparent){            
            $tr_color = imagecolorallocate($imResampled, $this->backgroundColor[0], $this->backgroundColor[1], $this->backgroundColor[2]);
            imagecolortransparent($imResampled, $tr_color);
        }
